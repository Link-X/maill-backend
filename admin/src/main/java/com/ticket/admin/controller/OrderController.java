...
public class OrderController {
    ...
    @GetMapping("/{id}")
    public Result<?> getOrder(@Parameter(description = "订单数据库自增 id") @PathVariable Long id) {
    ...
    @GetMapping("/{id}/items")
    public Result<?> getOrderItems(@Parameter(description = "订单 id") @PathVariable Long id) {
